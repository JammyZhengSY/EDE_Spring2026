...
```{r project.setup, echo=TRUE, message=FALSE, erro=FALSE, warning=FALSE, results='hide'}
#Import libraries
library(tidyverse)
library(here)
library(knitr)
...
```{r boxplots of the distribution of Ozone levels by month for 2018, echo=FALSE,fig.align='left',fig.height=3,fig.width=6.5,fig.cap='Ozone distribution by month (2018)'}
...
epa_data %>%
  ...
  theme_minimal()
```
```{r boxplots of the distribution of Ozone levels by month for 2019,echo=FALSE,fig.align='left',fig.height=3,fig.width=6.5,fig.cap='Ozone distribution by month (2019)'}
...
Shiyi Zheng_Feb 28,2026

## Git Repository
https://github.com/JammyZhengSY/EDE_Spring2026
